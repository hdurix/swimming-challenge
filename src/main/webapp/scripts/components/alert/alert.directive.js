        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('swimmingchallengeApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-swimmingchallengeApp-error');
                                var entityKey = httpResponse.headers('X-swimmingchallengeApp-params');
                                if (errorHeader) {
